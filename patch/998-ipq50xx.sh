...
sed -i '$a https://mirrors.pku.edu.cn/openwrt/snapshots/targets/qualcommax/ipq50xx/kmods/6.12.69-1-31273030a951fca959ab57da71235081/packages.adb' /etc/apk/repositories.d/distfeeds.list
sed -i '$a https://mirrors.pku.edu.cn/immortalwrt/snapshots/targets/qualcommax/ipq50xx/packages/packages.adb' /etc/apk/repositories.d/distfeeds.list
