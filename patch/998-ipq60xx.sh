...
sed -i '$a https://mirrors.pku.edu.cn/openwrt/snapshots/targets/qualcommax/ipq60xx/kmods/6.12.67-1-67bbb6dcbb55390b208878d242522feb/packages.adb' /etc/apk/repositories.d/distfeeds.list
