...
sed -i '$a https://mirrors.pku.edu.cn/openwrt/snapshots/targets/qualcommax/ipq60xx/kmods/6.12.65-1-f6b429cfc1593744fe83ff5758a2aa6a/packages.adb' /etc/apk/repositories.d/distfeeds.list
