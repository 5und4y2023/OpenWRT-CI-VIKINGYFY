...
sed -i '$a https://mirrors.pku.edu.cn/immortalwrt/snapshots/targets/qualcommax/ipq807x/kmods/6.12.51-1-dec95421f0556d20b66e73b87de98517/packages.adb' /etc/apk/repositories.d/distfeeds.list
