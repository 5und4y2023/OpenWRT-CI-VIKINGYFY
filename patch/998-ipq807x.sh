...
sed -i '$a https://mirrors.pku.edu.cn/immortalwrt/snapshots/targets/qualcommax/ipq807x/kmods/6.12.63-1-acc9a60e374098b1889cbbcd51c241e4/packages.adb' /etc/apk/repositories.d/distfeeds.list
