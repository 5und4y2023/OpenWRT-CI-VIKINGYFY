...
sed -i '$a https://mirrors.pku.edu.cn/openwrt/snapshots/targets/qualcommax/ipq807x/kmods/6.12.68-1-b68f9bec3e75ab6c31a4f6b338bff52a/packages.adb' /etc/apk/repositories.d/distfeeds.list
